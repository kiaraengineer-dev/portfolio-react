...
const Header = memo(() => (
  <div className="text-center lg:mb-8 mb-2 px-[5%]">
    ...
    >
      ...
      Desenvolvendo experiências digitais modernas e acessíveis
      <Sparkles className="w-5 h-5 text-purple-400" />
    </p>
  </div>
));
...
const ProfileImage = memo(() => (
  <div className="flex justify-end items-center sm:p-12 sm:py-0 sm:pb-0 p-0 py-2 pb-2">
    <div className="relative group" data-aos="fade-up" data-aos-duration="1000">
      {/* Fundos gradientes otimizados com complexidade reduzida para dispositivos móveis. */}
      ...
      <div className="relative">
        <div className="w-72 h-72 sm:w-80 sm:h-80 rounded-full overflow-hidden shadow-[0_0_40px_rgba(120,119,198,0.3)] transform transition-all duration-700 group-hover:scale-105">
          ...
          {/* Efeitos de sobreposição otimizados - desativados em dispositivos móveis */}
          <div className="absolute inset-0 bg-gradient-to-b from-black/20 via-transparent to-black/40 z-10 transition-opacity duration-700 group-hover:opacity-0 hidden sm:block" />
          <div className="absolute inset-0 bg-gradient-to-t from-purple-500/20 via-transparent to-blue-500/20 z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-700 hidden sm:block" />

          <img
            src="/foto.jpg"
            alt="Foto de Kiara Toster"
    ...
    () => [
      {
        ...
        description: "Aplicações e interfaces desenvolvidas",
      ...
      },
      {
        ...
        label: "Certificados",
        description: "Cursos e formações concluídas",
        animation: "fade-up",
      },
      {
        icon: Globe,
        ...
        label: "Experiência",
        description: "Anos de aprendizado contínuo",
        animation: "fade-left",
      },
    ],
          ...
          <div className="space-y-6 text-center lg:text-left">
            ...
            <h1>
              <span
                ...
                data-aos-duration="1300"
              >
                Engenharia de Software & UI/UX Designer em formação
              </span>
            </h1>
            ...
            >
              ...
              desenvolvimento Front-End e UI/UX Design, e interesse futuro em
              aplicações móveis. Desenvolvo interfaces funcionais e intuitivas,
              buscando criar experiências digitais de qualidade e evoluir
              continuamente em cada projeto.
            </p>
            ...
            >
              ...
              <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
                "Foco em qualidade, usabilidade e evolução constante."
              </blockquote>
            </div>

            {/*colocar seu curriculo aqui, não colocou ainda*/}
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              ...
              >
                ...
                >
                  <FileText className="w-4 h-4 sm:w-5 sm:h-5" /> Baixar CV
                </button>
              </a>
